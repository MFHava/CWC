...
namespace cwc {
	namespace internal {
		...
		struct default_implementation_chaining<Implementation, TL::type_list<Head, Tail>> : Head::cwc_wrapper::template cwc_interface_implementation<Implementation, Tail> {};
