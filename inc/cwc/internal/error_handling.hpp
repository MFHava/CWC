...
namespace cwc {
	namespace internal {
		...
		auto call_and_return_error(Func func) noexcept -> error_code
			...
			//NOTE: currently not available: catch(const std::filesystem::filesystem_error & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std17_filesystem_error;     }
			catch(const std::ios_base::failure            & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std11_ios_base_failure;     }
			...
			catch(const std::underflow_error              & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_underflow_error;      }
			catch(const std::overflow_error               & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_overflow_error;       }
			catch(const std::range_error                  & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_range_error;          }
			catch(const std::runtime_error                & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_runtime_error;        }
			...
			catch(const std::out_of_range                 & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_out_of_range;         }
			catch(const std::length_error                 & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_length_error;         }
			catch(const std::domain_error                 & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_domain_error;         }
			catch(const std::invalid_argument             & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_invalid_argument;     }
			catch(const std::logic_error                  & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_logic_error;          }
			catch(const std::exception                    & exc) { return this_context().cwc$internal$context$error$3(exc.what()), error_code::std98_exception;            }
		...
		void validate(error_code code) {
			...
			auto message = [] {
				...
				if(this_context().cwc$internal$context$error$4(&msg) != error_code::no_error)
					msg = "CWC-ERROR: could not retrieve error message";//no reliable way to handle such an error!!
				return msg;
			};
			...
			for(auto mask : {UI{0}, UI{127}, UI{255} << 7, UI{255} << 15, UI{255} << 23})
				switch(code = static_cast<error_code>(~mask & static_cast<UI>(code))) {//slice inheritance level
					...
					case error_code::std98_logic_error:          throw std::logic_error{message()};
					case error_code::std98_invalid_argument:     throw std::invalid_argument{message()};
					case error_code::std98_domain_error:         throw std::domain_error{message()};
					case error_code::std98_length_error:         throw std::length_error{message()};
					case error_code::std98_out_of_range:         throw std::out_of_range{message()};
					...
					case error_code::std98_runtime_error:        throw std::runtime_error{message()};
					case error_code::std98_range_error:          throw std::range_error{message()};
					case error_code::std98_overflow_error:       throw std::overflow_error{message()};
					case error_code::std98_underflow_error:      throw std::underflow_error{message()};
					...
					case error_code::std11_ios_base_failure:     throw std::ios_base::failure{message()};
