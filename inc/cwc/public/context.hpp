...
namespace cwc {
	...
	class context : public component {
		...
		virtual void                 CWC_CALL cwc$internal$context$error$1(string_view msg) const noexcept =0;
		...
		virtual internal::error_code CWC_CALL cwc$internal$context$factory$4(string_view fqn, intrusive_ptr<component> * cwc_ret) const noexcept =0;
		virtual internal::error_code CWC_CALL cwc$internal$context$factory$5(string_view fqn, string_view id, intrusive_ptr<component> * cwc_ret) const noexcept =0;
	...
	public:
		...
		class cwc_implementation : public internal::default_implementation_chaining<CWCImplementation, CWCTypeList> {
			...
			void                 CWC_CALL cwc$internal$context$error$1(string_view msg) const noexcept final { static_cast<const CWCImplementation &>(*this).error(msg); }
			...
			internal::error_code CWC_CALL cwc$internal$context$factory$4(string_view fqn, intrusive_ptr<component> * cwc_ret) const noexcept final { return internal::call_and_return_error([&] { *cwc_ret = static_cast<const CWCImplementation &>(*this).factory(fqn); }); }
			internal::error_code CWC_CALL cwc$internal$context$factory$5(string_view fqn, string_view id, intrusive_ptr<component> * cwc_ret) const noexcept final { return internal::call_and_return_error([&] { *cwc_ret = static_cast<const CWCImplementation &>(*this).factory(fqn, id); }); }
		};
