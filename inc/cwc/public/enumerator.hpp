...
namespace cwc {
	...
	namespace internal {
		...
		class vtable_implementation<enumerator<Type, Byte0, Byte1, Byte2, Byte3, Byte4, Byte5, Byte6, Byte7, Byte8, Byte9, ByteA, ByteB, ByteC, ByteD, ByteE, ByteF>, Implementation, TypeList> : public internal::default_implementation_chaining<Implementation, TypeList> {
			const internal::error * CWC_CALL cwc$enumerator$end$0(boolean * cwc_ret) const noexcept final { return internal::call_and_return_error([&] { *cwc_ret = static_cast<const Implementation &>(*this).end(); }); }
			const internal::error * CWC_CALL cwc$enumerator$next$1() noexcept final { return internal::call_and_return_error([&] { static_cast<Implementation &>(*this).next(); }); }
			const internal::error * CWC_CALL cwc$enumerator$get$2(Type * cwc_ret) const noexcept final { return internal::call_and_return_error([&] { *cwc_ret = static_cast<const Implementation &>(*this).get(); }); }
