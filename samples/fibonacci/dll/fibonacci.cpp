...
extern "C" CWC_EXPORT void CWC_CALL cwc_create_fibonacci(void ** obj, void (**func)(void *, int, void **), int ctor, void ** args) { //TODO: this will be generated by CWCC
	switch(ctor) {
		case 0: *obj = new sample::fibonacci; break;
		case 1: *obj = new sample::fibonacci{*(int *)args[0]}; break;
		//default: unreachable(); break;
	}
	*func = [](void * obj, int op, void ** args) {
		switch(op) {
