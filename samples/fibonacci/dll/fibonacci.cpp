...
extern "C" CWC_EXPORT void CWC_CALL cwc_sample_fibonacci_sequence(int op, void * args[]) noexcept { //TODO: this will be generated by CWCC
	try {
		switch(op) {
			case 0: *reinterpret_cast<void **>(args[1]) = new sample::fibonacci; break;
			case 1: *reinterpret_cast<void **>(args[1]) = new sample::fibonacci{*reinterpret_cast<int *>(args[2])}; break;
			case 2: delete reinterpret_cast<sample::fibonacci *>(args[1]); break;
			case 3: *reinterpret_cast<::cwc::uint64 *>(args[3]) = reinterpret_cast<const sample::fibonacci *>(args[1])->calculate(*reinterpret_cast<const ::cwc::uint8 *>(args[2])); break;
